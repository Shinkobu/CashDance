...
public class Database {
    ...
    private static final List<CbChance> CB_PROPOSALS_DATABASE = new ArrayList<>();

    public static void addCbProposal(CbChance cbChance) {
        CB_PROPOSALS_DATABASE.add(cbChance);
    }
    ...
    public static List<CbChance> getCbProposalsDatabase() {
